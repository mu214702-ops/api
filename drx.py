...
TELEGRAM_CHANNEL = "https://t.me/+9UmDyaXDKKllYzM1"
...
CONFIG = {
    ...
    "feedback_group_id": -1003711180601, # Apne group ki ID yahan dalein
}
# --- [ EXPIRY CONFIGURATION ] ---
# Format: datetime(Year, Month, Day, Hour, Minute, Second)
SCRIPT_EXPIRY = datetime(2036, 5, 20, 12, 30, 30) 
...
def handle_expired_script(message):
    bot.reply_to(
        message, 
        "⚠️ <b>SCRIPT EXPIRE OWNER TO BUY PREMIUM SCRIPT @BMAX_OWNER</b>", 
        parse_mode="HTML")
...
def generate_key(length=10):
    return "BMAX-" + ''.join(random.choices(string.ascii_uppercase + string.digits, k=length))
...
def handle_genkey_advance(message):
    ...
    for _ in range(amount):
        ...
        key = "BMAX-" + ''.join(random.choices(string.ascii_uppercase + string.digits, k=10))
...
def handle_redeem(message):
    ...
    if len(cmd) != 2:
        usage_msg = (
            ...
            f"📝 <b>𝐄𝐱𝐚𝐦𝐩𝐥𝐞:</b>\n"
            f"<code>/redeem BMAX-ABC123XYZ</code>\n"
            f"━━━━━━━━━━━━━━━━━━━━━━\n"
...
def delete_key_advanced(message):
    ...
    if len(cmd) < 3:
        usage_msg = (
            ...
            "📝 <b>Usage:</b> <code>/dk key BMAX-A1B2-C3D4</code>\n"
            "━━━━━━━━━━━━━━━━━━━━━━"
        )
        bot.reply_to(message, usage_msg, parse_mode="HTML")
        return
            ...
            if os.path.exists(file_to_send):
                with open(file_to_send, "rb") as f:
                    bot.send_document(
                        message.chat.id, 
                        f, 
                        caption=f"📂 <b>𝐁𝐌𝐀𝐗-𝐏𝐎𝐖𝐄𝐑 𝐁𝐀𝐂𝐊𝐔𝐏</b>\n📄 File: <code>{file_to_send}</code>\n✅ Access Granted.",
                        parse_mode="HTML"
                    )
            else:
...
def show_master_admin_commands(message):
    ...
    master_list = (
        f"👑 <b>𝐁𝐌𝐀𝐗-𝐏𝐎𝐖𝐄𝐑 𝐌𝐀𝐒𝐓𝐄𝐑 𝐂𝐎𝐍𝐓𝐑𝐎𝐋</b>\n"
        f"━━━━━━━━━━━━━━━━━━━━━━\n\n"
...
def handshake():
    ...
    if not user_data:
        return jsonify({"status": "expired", "buy_url": "https://t.me/BMAX_OWNER"}), 200
...
def print_banner():
    ...
    banner = fr"""
{color}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
{color}  ____   __  __            __   __  _____   _____  __          __  ______  _____  
{color} |  _ \ |  \/  |     /\    \ \ / / |  __ \ / ____| \ \        / / |  ____||  __ \ 
{color} | |_) || \  / |    /  \    \ V /  | |__) | |  __   \ \  /\  / /  | |__   | |__) |
{color} |  _ < | |\/| |   / /\ \    > <   |  ___/| | |_ |   \ \/  \/ /   |  __|  |  _  / 
{color} | |_) || |  | |  / ____ \  / . \  | |    | |__| |    \  /\  /    | |____ | | \ \ 
{color} |____/ |_|  |_| /_/    \_\/_/ \_\ |_|     \_____|     \/  \/     |______||_|  \_\
                                                               
\033[1;37m                 🚀 BMAX POWER MASTER SCRIPT 🚀
{color}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
if __name__ == "__main__":
    ...
    while True:
        try:
            ...
            bot_info = bot.get_me()
            print(f"\033[1;32m[+] BMAX POWER BOT SUCCESSFUL ✅ STATED @{bot_info.username}\033[0m")
