...
show_banner() {
    echo -e "${CYAN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
    echo -e "${YELLOW}  ____   __  __            __   __  _____   _____  __          __  ______  _____  ${NC}"
    echo -e "${YELLOW} |  _ \ |  \/  |     /\    \ \ / / |  __ \ / ____| \ \        / / |  ____||  __ \ ${NC}"
    echo -e "${YELLOW} | |_) || \  / |    /  \    \ V /  | |__) | |  __   \ \  /\  / /  | |__   | |__) |${NC}"
    echo -e "${YELLOW} |  _ < | |\/| |   / /\ \    > <   |  ___/| | |_ |   \ \/  \/ /   |  __|  |  _  / ${NC}"
    echo -e "${YELLOW} | |_) || |  | |  / ____ \  / . \  | |    | |__| |    \  /\  /    | |____ | | \ \ ${NC}"
    echo -e "${YELLOW} |____/ |_|  |_| /_/    \_\/_/ \_\ |_|     \_____|     \/  \/     |______||_|  \_\${NC}"
echo -e"${CYAN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
    echo -e "       ${GREEN}🚀 BMAX POWER SYSTEM RENDER-INSTALLER v3.2 🚀${NC}"
